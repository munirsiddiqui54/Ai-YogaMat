  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.posesContainer}>
        {poses.map((pose: any) => (
          <View key={pose.english_name} style={styles.poseContainer}>
            ...
            <Text style={styles.poseDetailText}>
              Target Body Parts: {pose.target_body_parts.join(", ")}
            </Text>
            <Text style={styles.poseDetailText}>
              Benefits: {pose.benefits.join(", ")}
            </Text>
            <Text style={styles.poseDetailText}>
              Contraindications: {pose.contraindications.join(", ")}
            </Text>
          </View>
        ))}
      </View>
